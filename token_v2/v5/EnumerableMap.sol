...
library EnumerableMap {
     ...
     */
    function at(Map storage map, uint256 index) internal view returns (address, uint256) {
        address key = map._keys.at(index);
        return (key, map._values[key]);
    }
    
    function indexOfKey(Map storage map, address key) internal view returns (int256) {
     ...
     */
    function tryGet(Map storage map, address key) internal view returns (bool, uint256) {
